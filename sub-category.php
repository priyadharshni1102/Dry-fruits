...
<!-- ============================================== COLOR: END ============================================== -->
	...
	<div id="category" class="category-carousel hidden-xs">
		<div class="item">	
			<div class="image">
				<img src="https://www.bhagwatidryfruits.com/assets/images/sliders/dry-fruits-banner.jpg" alt="" class="img-responsive">
			</div>
...
while($row=mysqli_fetch_array($sql))
{
    ?>
					...
					<div class="excerpt hidden-sm hidden-md"><mark>
						<?php echo htmlentities($row['subcategory']);?></mark>
					</div>
			<?php } ?>
