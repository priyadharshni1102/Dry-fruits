...
<?php }} ?>
    ...
    <input type="text" class="form-control" name="productName"  placeholder="Enter Product Name" value="<?php echo htmlentities($row['productName']);?>">
  </div>
  <div class="form-group">
    <label for="basicinput">Product Company</label>
    <input type="text" class="form-control" name="productCompany"  placeholder="Enter Product Comapny Name" value="<?php echo htmlentities($row['productCompany']);?>" required>
  </div>
  <div class="form-group">
    <label for="basicinput">Product Price Before Discount</label>
    <input type="text" class="form-control" name="productpricebd"  placeholder="Enter Product Price" value="<?php echo htmlentities($row['productPriceBeforeDiscount']);?>" required>
  </div>
  <div class="form-group">
    <label for="basicinput">Product Price After Discount(Selling Price)</label>
    <input type="text" class="form-control" name="productprice"  placeholder="Enter Product Price" value="<?php echo htmlentities($row['productPrice']);?>" required>
  </div>
  <div class="form-group">
    <label for="basicinput">Product Descrition</label>
    <textarea class="form-control" name="productDescription"  placeholder="Enter Product Description" rows="5"> <?php echo htmlentities($row['productDescription']);?> </textarea>
  </div>
  <div class="form-group">
    <label for="basicinput">Product Shipping Charge</label>
    <input type="text" class="form-control" name="productShippingcharge"  placeholder="Enter Product Shipping Charge" value="<?php echo htmlentities($row['shippingCharge']);?>" required>
  </div>
  <div class="form-group">
